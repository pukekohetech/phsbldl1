// ──────────────────────────────────────────────────────────────
//  questions.js – FINAL VERSION (with 50+ safe secret words)
// ──────────────────────────────────────────────────────────────
...
// Big list of easy-to-type NZ/Māori nature words – no macrons!
const SECRET_WORDS = [
  "kiwi", "tui", "pukeko", "kaka", "kakapo", "kea", "kereru", "fantail",
  "morepork", "ruru", "piwakawaka", "hihi", "kakariki", "korimako",
  "miromiro", "pohutukawa", "kowhai", "manuka", "kanuka", "rata",
  "rimu", "kauri", "totara", "matai", "kahikatea", "tawa", "puriri",
  "rewarewa", "nikau", "cabbagetree", "flax", "pingao", "toetoe",
  "silverfern", "koru", "punga", "weta", "tuatara", "gecko", "skink",
  "maui", "hector", "paua", "kina", "pipi", "tuatua", "cockle", "mussel"
];
...
// ───── Export the word list so index.html can use it ─────
window.SECRET_WORDS = SECRET_WORDS;   // makes it globally available
